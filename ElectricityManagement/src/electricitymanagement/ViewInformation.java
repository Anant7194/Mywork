...
public class ViewInformation extends JFrame implements ActionListener{
    ...
    ViewInformation(String meter){
        ...
        l13.setFont(new Font("Verdana", Font.ITALIC, 16));
        add(l13);
        ...
        l14.setBounds(250, 260, 100, 20);
         l14.setFont(new Font("Verdana", Font.ITALIC, 16));
        add(l14);
        ...
        l15.setFont(new Font("Verdana", Font.ITALIC, 16));
        add(l15);
        ...
        l16.setFont(new Font("Verdana", Font.ITALIC, 16));
        add(l16);
        ...
        l17.setFont(new Font("Verdana", Font.ITALIC, 16));
        add(l17);
